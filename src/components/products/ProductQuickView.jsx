...
const ProductQuickView = ({
  ...
  return (
    <Dialog open={open} handler={onOpen}>
      <div className="box-border h-full w-full px-6 py-10 bg-white rounded-lg relative lg:w-[848px] lg:h-max">
        <IconButton
        ...
        <Typography className="font-bold text-xl text-gray-900 mb-8">
          {description}
        </Typography>

        <div className="h-full flex flex-col lg:flex-row gap-4 justify-between">
